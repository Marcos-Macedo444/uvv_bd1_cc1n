...
/*Adicionando checagem na tabela (lojas.envios) para que a
coluna "status" ela dê os resultados informados
...
/*Adicionando checagem na tabela (lojas.pedidos) para que a
coluna "status" dê as especificações conforme foi
atualizado.*/  
...
/*Adicionando checagem na tabela (lojas.pedidos_itens) na
coluna "preco_unitario" para que o preço
seja maior que 0.*/
...
/*Adicionando as foreign keys necessárias,
